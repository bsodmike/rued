...
pub struct MeterClassic<'a, const DIGITS: usize = 8> {
...
impl<'a, const DIGITS: usize> MeterClassic<'a, DIGITS> {
...
impl<'a, const DIGITS: usize> Default for MeterClassic<'a, DIGITS> {
    fn default() -> Self {
        Self::new()
    }
}
